...
namespace ArchImgProc
{
	...
	private:
		...
		static calcFLT DefaultQuant() constexpr { return static_cast<calcFLT>(2.0); }       /* Bound to the quantization error on the
																				  gradient norm.								    */
		static calcFLT DefaultAng_th() constexpr  { return static_cast<calcFLT>(22.5); }     /* Gradient angle tolerance in degrees.           */
		static calcFLT DefaultLog_eps() constexpr { return 0; }							  /* Detection threshold: -log10(NFA) > log_eps     */
		static calcFLT DefaultDensity_th() constexpr { return  static_cast<calcFLT>(0.7); } /* Minimal density of region points in rectangle. */
		static int DefaultN_bins() constexpr { return 1024; }
	public:
		typedef LineSegment<calcFLT> LineSegment;
